...
import { IJobPost, IListDataJobs, IListJobs } from '../../../interfaces'
                ...
                if (item.status === 0 || item.status === 2) {
                    ...
                    return (
                        <div className='my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 '>
                            <Link to={`/job-detail/${item.id}`} className='shadow-lg p-2'>
                                ...
                                <p className='flex items-center gap-1 my-2'> <MdRoom /> <span>{item.address}</span> </p>
